  ...
  return (
    <section className='grid grid-cols-2 overflow-scroll overflow-x-hidden'>
      {allMovies && allMovies.map(movie => {
        return (
          <article key={movie.movie_id} className="bg-gray-200 flex gap-5 m-1 rounded">
            ...
            <div className='flex flex-col justify-center items-center gap-2'>
              ...
              <button className="text-white bg-gray-500 hover:bg-gray-600 px-3 py-2 rounded-md text-sm font-medium">
